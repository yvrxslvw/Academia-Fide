			...
			<div class="container">
				...
				<div class="header__menu">
					...
					<div class="menu__body">
						...
						<div class="menu__item _there">Условия</div>
			...
			<div class="content">
				<div class="container">
					<div class="post__item">
						<p>Все авторские права на данный веб-ресурс www.academiafide.com (далее веб-сайт), а также на видеоуроки, видеоматериалы и личные занятия с тренерами, зарегистрированы и принадлежат организации Academia FIDE. </p>
						<p>Под действием этих прав запрещается копирование/использование для распространения в личных целях видеоуроков и видеоматериалов, продаваемых на этом веб-сайте. Также запрещается копирование/использование в личных целях дизайна и контента веб-сайта.</p>
					</div>
					<div class="post__item">
						<p>Ценовая категория на каждый видеоурок или видеоматериал, а также на курсы для каждого уровня, заранее указаны на странице магазина веб-сайта.</p>
						<p>При покупке личных занятий с FIDE тренерами цена и условия обговариваются заранее.</p>
						<p>Если посетитель веб-сайта не получил видеоматериал как таковой, то он имеет право получить обратно денежные средства, потраченные на покупку какого-либо материала.</p>
						<p>Качество обучения в личных занитиях, в видеоматериалах, в видеоуроках и в семинарах обжалованию не подлежит.</p>
					</div>
				</div>
			</div>
		</main>
